function relativeMotionPlot_4cases(LD,RD,motion,apm,step_size,OCS_Disp)
...
%     PD_FSP_R = cell2mat(RD(5,2));
    ...
    % Labels for Legend
    if isequal(MCase,1)
        labels = {'Posterior','None','Anterior'};
    elseif isequal(MCase,2)
        labels = {'Distal','None','Proximal'};
    elseif isequal(MCase,3)
        labels = {'Posterior-Distal','None','Anterior-Proximal'};
    elseif isequal(MCase,4)
        labels = {'Posterior-Proximal','None','Anterior-Distal'};
    end
