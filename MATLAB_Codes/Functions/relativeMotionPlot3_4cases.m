function relativeMotionPlot3_4cases(LD,RD,motion,apm,step_size,OCS_Disp)
...
%         FSP_PD_R(d,:) = PD_FSP_R(d,[1:step_size:end,end]);
    ...
    % Tile-1.1
    nexttile;
    p(1)=plot(time_range,SP_AP_L(1,:),'k^-','MarkerIndices',1:40:length(time_range),'MarkerSize',3);
    hold on;
    p(2)=plot(time_range,SP_AP_L(2,:),'k-');
    p(3)=plot(time_range,SP_AP_L(3,:),'kv-','MarkerIndices',1:40:length(time_range),'MarkerSize',3);
    hold off;
    grid on;
    xlim([0 5.76])
    ylim([-20 20])
    xticks([0,2.88,5.76]),yticks([-20,-10,0,10,20])
    %xlabel('Time (s)')
    ylabel('A-P Motion (mm)')
    title('Left Leg')
    % Tile-1.2
    nexttile;
    plot(time_range,SP_AP_R(1,:),'k^-','MarkerIndices',1:40:length(time_range),'MarkerSize',3);
    hold on;
    plot(time_range,SP_AP_R(2,:),'k-');
    plot(time_range,SP_AP_R(3,:),'kv-','MarkerIndices',1:40:length(time_range),'MarkerSize',3);
    hold off;
    grid on;
    xlim([0 5.76])
    ylim([-20 20])
    ...
    % Tile-2.1
    nexttile;
    plot(time_range,SP_PD_L(1,:),'k^-','MarkerIndices',1:40:length(time_range),'MarkerSize',3);
    hold on;
    plot(time_range,SP_PD_L(2,:),'k-');
    plot(time_range,SP_PD_L(3,:),'kv-','MarkerIndices',1:40:length(time_range),'MarkerSize',3);
    hold off;
    grid on;
    xlim([0 5.76])
    ylim([-10 10])
    xticks([0,2.88,5.76]),yticks([-10,-5,0,5,10])
    xlabel('Time (s)')
    ylabel('P-D Motion (mm)')
    % Tile-2.2
    nexttile;
    plot(time_range,SP_PD_R(1,:),'k^-','MarkerIndices',1:40:length(time_range),'MarkerSize',3);
    hold on;
    plot(time_range,SP_PD_R(2,:),'k-');
    plot(time_range,SP_PD_R(3,:),'kv-','MarkerIndices',1:40:length(time_range),'MarkerSize',3);
    hold off;
    grid on;
    xlim([0 5.76])
    ylim([-10 10])
    ...
    % Tile-1.1
    nexttile;
    p(1)=plot(time_range,TP_AP_L(1,:),'k^-','MarkerIndices',1:40:length(time_range),'MarkerSize',3);
    hold on;
    p(2)=plot(time_range,TP_AP_L(2,:),'k-');
    p(3)=plot(time_range,TP_AP_L(3,:),'kv-','MarkerIndices',1:40:length(time_range),'MarkerSize',3);
    hold off;
    grid on;
    xlim([0 5.76])
    ylim([-20 20])
    ...
    % Tile-1.2
    nexttile;
    plot(time_range,TP_AP_R(1,:),'k^-','MarkerIndices',1:40:length(time_range),'MarkerSize',3);
    hold on;
    plot(time_range,TP_AP_R(2,:),'k-');
    plot(time_range,TP_AP_R(3,:),'kv-','MarkerIndices',1:40:length(time_range),'MarkerSize',3);
    hold off;
    grid on;
    xlim([0 5.76])
    ylim([-20 20])
    ...
    % Tile-2.1
    nexttile;
    plot(time_range,TP_PD_L(1,:),'k^-','MarkerIndices',1:40:length(time_range),'MarkerSize',3);
    hold on;
    plot(time_range,TP_PD_L(2,:),'k-');
    plot(time_range,TP_PD_L(3,:),'kv-','MarkerIndices',1:40:length(time_range),'MarkerSize',3);
    hold off;
    grid on;
    xlim([0 5.76])
    ylim([-10 10])
    ...
    % Tile-2.2
    nexttile;
    plot(time_range,TP_PD_R(1,:),'k^-','MarkerIndices',1:40:length(time_range),'MarkerSize',3);
    hold on;
    plot(time_range,TP_PD_R(2,:),'k-');
    plot(time_range,TP_PD_R(3,:),'kv-','MarkerIndices',1:40:length(time_range),'MarkerSize',3);
    hold off;
    grid on;
    xlim([0 5.76])
    ylim([-10 10])
    ...
    % Tile-1.1
    nexttile;
    p(1)=plot(time_range,FP_AP_L(1,:),'k^-','MarkerIndices',1:40:length(time_range),'MarkerSize',3);
    hold on;
    p(2)=plot(time_range,FP_AP_L(2,:),'k-');
    p(3)=plot(time_range,FP_AP_L(3,:),'kv-','MarkerIndices',1:40:length(time_range),'MarkerSize',3);
    hold off;
    grid on;
    xlim([0 5.76])
    ylim([-20 20])
    ...
    % Tile-1.2
    nexttile;
    plot(time_range,FP_AP_R(1,:),'k^-','MarkerIndices',1:40:length(time_range),'MarkerSize',3);
    hold on;
    plot(time_range,FP_AP_R(2,:),'k-');
    plot(time_range,FP_AP_R(3,:),'kv-','MarkerIndices',1:40:length(time_range),'MarkerSize',3);
    hold off;
    grid on;
    xlim([0 5.76])
    ylim([-20 20])
    ...
    % Tile-2.1
    nexttile;
    plot(time_range,FP_PD_L(1,:),'k^-','MarkerIndices',1:40:length(time_range),'MarkerSize',3);
    hold on;
    plot(time_range,FP_PD_L(2,:),'k-');
    plot(time_range,FP_PD_L(3,:),'kv-','MarkerIndices',1:40:length(time_range),'MarkerSize',3);
    hold off;
    grid on;
    xlim([0 5.76])
    ylim([-20 20])
    ...
    % Tile-2.2
    nexttile;
    plot(time_range,FP_PD_R(1,:),'k^-','MarkerIndices',1:40:length(time_range),'MarkerSize',3);
    hold on;
    plot(time_range,FP_PD_R(2,:),'k-');
    plot(time_range,FP_PD_R(3,:),'kv-','MarkerIndices',1:40:length(time_range),'MarkerSize',3);
    hold off;
    grid on;
    xlim([0 5.76])
    ylim([-20 20])
